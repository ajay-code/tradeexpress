...
<div id="templatic_browse_by_categories-1" class="widget browse_by_categories">
  <h3 class="widget-title">Find By Category</h3>
  <div>
    <ul class="browse_by_category">
      <?php $selector=rand(1,4);?>
      <?php
if($selector==1){
	$category=getDetails(doSelect("gic_id,category","general_item_category",array("parent_id"=>0),' ORDER BY rand()'));
	foreach($category as $k=>$v){
?>
      <li class="cat-item cat-item-15"><a href="general_item_listing.php?category=<?php echo $v["gic_id"]; ?>" ><?php echo $v["category"]; ?></a> <?php /*?>(<?php echo total_general_item_by_cat($v["gic_id"]);  ?>)<?php */?>
        <?php
...
?>
          <li class="cat-item cat-item-18"><a href="general_item_listing.php?category=<?php echo $v["gic_id"]; ?>&sub_category=<?php echo $v1["gic_id"]; ?>" ><?php echo $v1["category"]; ?></a><?php /*?> (<?php echo total_general_item_by_sub_cat($v1["gic_id"]);  ?>)<?php */?>
            <?php
}
?>
            <?php
...
?>
              <li class="cat-item cat-item-47"><a href="general_item_listing.php?category=<?php echo $v["gic_id"]; ?>&sub_category=<?php echo $v1["gic_id"]; ?>&sub_sub_category=<?php echo $v2["gic_id"]; ?>" ><?php echo $v2["category"]; ?></a><?php /*?> (<?php echo total_general_item_by_sub_sub_cat($v2["gic_id"]);  ?>)<?php */?></li>
              <?php
}
?>
            </ul>
...
if($selector==2){
	...
	foreach($category as $k=>$v){
?>
      <li class="cat-item cat-item-15"><a href="property_listing.php?category=<?php echo $v["pc_id"]; ?>" ><?php echo $v["category"]; ?></a><?php /*?> (<?php echo total_property_by_cat($v["pc_id"]); ?>)<?php */?>
        <?php
...
foreach($sub_category as $k1=>$v1){
?>
          <li class="cat-item cat-item-18"><a href="property_listing.php?category=<?php echo $v["pc_id"]; ?>&sub_category=<?php echo $v1["pc_id"]; ?>" ><?php echo $v1["category"]; ?></a><?php /*?> (<?php echo total_property_by_sub_cat($v1["pc_id"]); ?>)<?php */?>
            <?php
}
?>
            <?php
...
foreach($sub_sub_category as $k2=>$v2){
?>
              <li class="cat-item cat-item-47"><a href="property_listing.php?category=<?php echo $v["pc_id"]; ?>&sub_category=<?php echo $v1["pc_id"]; ?>&sub_sub_category=<?php echo $v2["pc_id"]; ?>" ><?php echo $v2["category"]; ?></a><?php /*?> (<?php echo total_property_by_sub_sub_cat($v2["pc_id"]); ?>)<?php */?></li>
              <?php
}
?>
            </ul>
...
if($selector==3){
	...
	foreach($category as $k=>$v){
?>
      <li class="cat-item cat-item-15"><a href="car_listing.php?category=<?php echo $v["cc_id"]; ?>" ><?php echo $v["category"]; ?></a><?php /*?> (
        <?php  echo total_car_by_cat($v["cc_id"]); ?>
        )<?php */?>
        <?php
...
foreach($sub_category as $k1=>$v1){
?>
          <li class="cat-item cat-item-18"><a href="car_listing.php?category=<?php echo $v["cc_id"]; ?>&sub_category=<?php echo $v1["cc_id"]; ?>" ><?php echo $v1["category"]; ?></a> <?php /*?>(
            <?php  echo total_car_by_sub_cat($v1["cc_id"]); ?>
            )<?php */?>
            <?php
}
?>
...
foreach($sub_sub_category as $k2=>$v2){
?>
              <li class="cat-item cat-item-47"><a href="car_listing.php?category=<?php echo $v["cc_id"]; ?>&sub_category=<?php echo $v1["cc_id"]; ?>&sub_sub_category=<?php echo $v2["cc_id"]; ?>" ><?php echo $v2["category"]; ?></a> <?php /*?>(
                <?php  echo total_car_by_sub_sub_cat($v2["cc_id"]); ?>
                )<?php */?></li>
              <?php
}
?>
...
if($selector==4){
	...
	foreach($category as $k=>$v){
?>
      <li class="cat-item cat-item-15"><a href="job_listing.php?category=<?php echo $v["jc_id"]; ?>" ><?php echo $v["category"]; ?></a><?php /*?> (
        <?php  echo total_job_by_cat($v["jc_id"]); ?>
        )<?php */?>
        <?php
...
foreach($sub_category as $k1=>$v1){
?>
          <li class="cat-item cat-item-18"><a href="job_listing.php?category=<?php echo $v["jc_id"]; ?>&sub_category=<?php echo $v1["jc_id"]; ?>" ><?php echo $v1["category"]; ?></a> <?php /*?>(
            <?php  echo total_job_by_sub_cat($v1["jc_id"]); ?>
            )<?php */?>
            <?php
}
?>
...
foreach($sub_sub_category as $k2=>$v2){
?>
              <li class="cat-item cat-item-47"><a href="job_listing.php?category=<?php echo $v["jc_id"]; ?>&sub_category=<?php echo $v1["jc_id"]; ?>&sub_sub_category=<?php echo $v2["jc_id"]; ?>" ><?php echo $v2["category"]; ?></a><?php /*?> (
                <?php  echo total_job_by_sub_sub_cat($v2["jc_id"]); ?>
                )<?php */?></li>
              <?php
}
?>
