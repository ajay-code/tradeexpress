...
<li><a href="../">Visit Trade Website</a></li>
<li><a href="../../">Visit Bulafaces Website</a></li>
...
<li class="dropdown dropdown-fuse">
	<a href="#" class="dropdown-toggle fw600" data-toggle="dropdown">
		<span class="hidden-xs">
			<name>
				<?php echo $admin_details[0]["full_name"];  ?> </name>
		</span>
	...
	<ul class="dropdown-menu list-group keep-dropdown w250" role="menu">
		...
		<li class="dropdown-footer text-center">
			<a href="change_password.php" class="btn btn-primary btn-sm btn-bordered">
				<span class="fa fa-power-off pr5"></span> Change Password </a>
		</li>
		<li class="dropdown-footer text-center">
...
<li>
<a href="property_video_gallery.php">
...
<span class="fa fa-file-text-o"></span>Update Car Category Extra Field</a>
</li>
<li>
...
<li>
<a class="accordion-toggle <?php //echo $o; ?>" href="#">
<span class="fa fa-wrench"></span>
...
<li>
<a href="approve_customer_listing.php">
<span class="fa fa-file-text-o"></span>Approve Customer</a>
</li>
<li>
<a href="suspend_customer_listing.php">
<span class="fa fa-file-text-o"></span>Suspend Customer</a>
</li>
</ul>
</li>
...
<span class="fa fa-cogs"></span>
<span class="sidebar-title">Slider Settings</span>
<span class="caret"></span>
</a>
<ul class="nav sub-nav">
<li>
<a href="addSlides.php">
<span class="fa fa-file-text-o"></span>Slides</a>
</li>
</ul>
...
<span class="fa fa-file-text-o"></span>Add Contact No</a>
</li>
<li>
<a href="add_social_media.php">
<span class="fa fa-file-text-o"></span>Add Social Medial Link</a>
</li>
<li>
<a href="add_email.php">
<span class="fa fa-file-text-o"></span>Add Website Email</a>
</li>
<li>
