...
function fetch_field(cat_id,ajax_id){
	var jc_id=$("#"+cat_id).val();
	//alert(gic_id);
	$.post(
	"ajax_updt_job_xtra_fld_form.php",
	{jc_id:jc_id},
	function(r){
		//alert(r);
		$("#"+ajax_id).html(r);
...
function update_field(jcef_id,type){
	var label_name=$("#label_name"+jcef_id).val();
	var field_name=$("#field_name"+jcef_id).val();
	$.post(
	"ajax_updt_job_extra_field.php",
	{jcef_id:jcef_id,label_name:label_name,field_name:field_name,type:type},
	function(r){
		if(r==1){
		location.reload();
		}else{
...
function update_field_drodown(jcef_id,type){
	//alert(jc_id);
	var label_name=$("#label_name"+jcef_id).val();
	var field_name=$("#field_name"+jcef_id).val();
	...
	$.post(
	"ajax_updt_job_extra_field.php",
	{jcef_id:jcef_id,label_name:label_name,field_name:field_name,value:data,type:type},
	function(r){
		if(r==1){
		location.reload();
		}else{
...
function update_field_drodown1(jcef_id,type){
	//alert(jc_id);
	var label_name=$("#label_name"+jcef_id).val();
	var field_name=$("#field_name"+jcef_id).val();
	/* var values = $("input[name='option_array[]']").map(function(){return $(this).val();}).get();
...
function delete_field(jcef_id){
	$.post(
	"ajax_updt_job_extra_field.php",
	{jcef_id:jcef_id,action:'delete'},
	function(r){
		if(r==1){
...
<a href="javascript:void(0);">Update Job Category Extra Field</a>
</li>
</ol>
</div>
</div>
...
<select id="cat1" name="jc_id" onchange="fetch_field('cat1','ajax_form1');" >
...
<div class="section">
<label class="field select">
<select id="sub_cat2" name="jc_id"  onchange="fetch_field('sub_cat2','ajax_form2');" >
...
<div class="section">
<label class="field select">
<select id="sub_sub_cat3" name="jc_id"   onchange="fetch_field('sub_sub_cat3','ajax_form3');" >
