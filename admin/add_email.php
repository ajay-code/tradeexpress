...
<div class="panel-title" style="color: #111668;">Add Email Link
</div>
</div>
...
<h6 class="pull-right" id="add_country_error"></h6>
<label class="field prepend-icon">
<input type="text"  name="link" id="link"  class="gui-input" placeholder="E-Mail">
<label for="tooltip1" class="field-icon">
<i class="fa fa-sign-out"></i>
</label>
</label>
...
<div class="panel">
<div class="panel-heading">
<div class="panel-title" style="color: #111668;">Email Link Listing
</div>
</div>
