...
<a href="javascript:void(0);">Price For Classified & Auction, SubTitle, Listed In Second Category</a>
</li>
</ol>
</div>
</div>
...
<option value="classified">Rental Combo</option>
<option value="auction">Rental Feature</option>
...
<option value="Highlight">Rental Highlights</option>
<option value="Bold_Title">Rental Bold</option>
...
<?php
$for_what="";
if($v["for_what"]=="classified"){
$for_what="Rental Combo";	
}else if($v["for_what"]=="auction"){
