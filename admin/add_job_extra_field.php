...
$("#add_category_extra_field").on('submit',(function(e){  
	$.ajax({
        	url: "ajax_add_job_extra_field.php?type=dropdown",
			type: "POST",
...
<a href="javascript:void(0);">Job Category Extra Field</a>
</li>
</ol>
</div>
</div>
...
<div class="section">
<label class="field select">
<select id="sub_sub_cat3" name="jc_id" >
