...
function no_border(id){
	...
	$.post(
		"ajax_add_update_property_cat.php",
...
function update_category_validation(){
	...
	$.post(
	"ajax_add_update_property_cat.php",
	{pc_id:category,category:new_category,msg:'update_category'},
	function(res){
		var r=res.split("||");
			if(r[1]==1){
...
function add_subcat_validation(){
	...
	$.post(
	"ajax_add_update_property_cat.php",
	{pc_id:pc_id,category:category,msg:'add_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_subcat_validation(){
	...
	$.post(
	"ajax_add_update_property_cat.php",
	{pc_id:pc_id,category:category,msg:'update_subcat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function add_sub_subcat_validation(){
	...
	$.post(
	"ajax_add_update_property_cat.php",
	{pc_id:pc_id,category:category,msg:'add_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_sub_subcat_validation(){
	...
	var pc_id=$("#update_subcat1").val();
	if(pc_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('update_subcat1');
		return false;
	}
	var pc_id=$("#update_sub_subcat1").val();
	if(pc_id.trim()=="0"){
	...
	$.post(
	"ajax_add_update_property_cat.php",
	{pc_id:pc_id,category:category,msg:'update_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Category added successfully");
...
function delete_sub_subcat_validation(){
	...
	var pc_id=$("#delete_subcat1").val();
	if(pc_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('delete_subcat1');
		return false;
	}
	var pc_id=$("#delete_sub_subcat1").val();
	if(pc_id.trim()=="0"){
		alert("Please Select Sub Sub Category");
		error_border('delete_subcat1');
		return false;
	...
	$.post(
	"ajax_add_update_property_cat.php",
	{pc_id:pc_id,msg:'delete_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Category added successfully");
...
<a href="javascript:void(0);">Add Property Category</a>
</li>
</ol>
</div>
</div>
