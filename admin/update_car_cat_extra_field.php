...
function fetch_field(cat_id,ajax_id){
	...
	//alert(gic_id);
	$.post(
	"ajax_updt_car_xtra_fld_form.php",
	{cc_id:cc_id},
	function(r){
		//alert(r);
		$("#"+ajax_id).html(r);
...
function update_field(ccef_id,type){
	//alert(ccef_id);
	var label_name=$("#label_name"+ccef_id).val();
	var field_name=$("#field_name"+ccef_id).val();
	$.post(
	"ajax_updt_car_extra_field.php",
	{ccef_id:ccef_id,label_name:label_name,field_name:field_name,type:type},
	function(r){
		if(r==1){
		location.reload();
		}else{
...
function update_field_drodown(ccef_id,type){
	//alert(ccef_id);
	var label_name=$("#label_name"+ccef_id).val();
	var field_name=$("#field_name"+ccef_id).val();
	...
	$.post(
	"ajax_updt_car_extra_field.php",
	{ccef_id:ccef_id,label_name:label_name,field_name:field_name,value:data,type:type},
	function(r){
		if(r==1){
		location.reload();
		}else{
...
function update_field_drodown1(ccef_id,type){
	//alert(ccef_id);
	var label_name=$("#label_name"+ccef_id).val();
	var field_name=$("#field_name"+ccef_id).val();
	/* var values = $("input[name='option_array[]']").map(function(){return $(this).val();}).get();
...
function delete_field(ccef_id){
	$.post(
	"ajax_updt_car_extra_field.php",
	{ccef_id:ccef_id,action:'delete'},
	function(r){
		if(r==1){
...
<a href="javascript:void(0);">Update Car Category Extra Field</a>
</li>
</ol>
</div>
</div>
...
<select id="cat1" name="cc_id" onchange="fetch_field('cat1','ajax_form1');" >
...
<div class="section">
<label class="field select">
<select id="sub_cat2" name="cc_id"  onchange="fetch_field('sub_cat2','ajax_form2');" >
...
<div class="section">
<label class="field select">
<select id="sub_sub_cat3" name="cc_id"   onchange="fetch_field('sub_sub_cat3','ajax_form3');" >
