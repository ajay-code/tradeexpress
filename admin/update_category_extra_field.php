...
function fetch_field(cat_id,ajax_id){
	var gic_id=$("#"+cat_id).val();
	//alert(gic_id);
	$.post(
	"ajax_updt_ctgry_xtra_fld_form.php",
	{gic_id:gic_id},
	function(r){
		//alert(r);
		$("#"+ajax_id).html(r);
...
function update_field(gcef_id,type){
	//alert(gcef_id);
	var label_name=$("#label_name"+gcef_id).val();
	var field_name=$("#field_name"+gcef_id).val();
	$.post(
	"ajax_updt_general_extra_field.php",
	{gcef_id:gcef_id,label_name:label_name,field_name:field_name,type:type},
	function(r){
		if(r==1){
		location.reload();
		}else{
...
function update_field_drodown(gcef_id,type){
	//alert(gcef_id);
	var label_name=$("#label_name"+gcef_id).val();
	var field_name=$("#field_name"+gcef_id).val();
	...
	$.post(
	"ajax_updt_general_extra_field.php",
	{gcef_id:gcef_id,label_name:label_name,field_name:field_name,value:data,type:type},
	function(r){
		if(r==1){
		location.reload();
		}else{
...
function update_field_drodown1(gcef_id,type){
	//alert(gcef_id);
	var label_name=$("#label_name"+gcef_id).val();
	var field_name=$("#field_name"+gcef_id).val();
	/* var values = $("input[name='option_array[]']").map(function(){return $(this).val();}).get();
...
function delete_field(gcef_id){
	$.post(
	"ajax_updt_general_extra_field.php",
	{gcef_id:gcef_id,action:'delete'},
	function(r){
		if(r==1){
...
<a href="javascript:void(0);">Update General Item Extra Field</a>
</li>
</ol>
</div>
</div>
...
<select id="cat1" name="gic_id" onchange="fetch_field('cat1','ajax_form1');" >
...
<div class="section">
<label class="field select">
<select id="sub_cat2" name="gic_id"  onchange="fetch_field('sub_cat2','ajax_form2');" >
...
<div class="section">
<label class="field select">
<select id="sub_sub_cat3" name="gic_id"   onchange="fetch_field('sub_sub_cat3','ajax_form3');" >
...
<div class="section">
<label class="field select">
<select id="sub_sub_sub_cat5" name="gic_id"  onchange="fetch_field('sub_sub_sub_cat5','ajax_form4');" >
