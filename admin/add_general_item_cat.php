...
function no_border(id){
	...
	$.post(
		"ajax_add_update_general_item_cat.php",
...
function update_category_validation(){
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:category,category:new_category,msg:'update_category'},
	function(res){
		var r=res.split("||");
			if(r[1]==1){
...
{
	var gic_id=$("#delete_category_field").val();
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,msg:'delete_category'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function add_subcat_validation(){
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,category:category,msg:'add_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_subcat_validation(){
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,category:category,msg:'update_subcat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function delete_subcat_validation(){
	...
	var gic_id=$("#subcat_delete").val();
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,msg:'delete_subcat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function add_sub_subcat_validation(){
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,category:category,msg:'add_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_sub_subcat_validation(){
	...
	var gic_id=$("#update_subcat1").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('update_subcat1');
		return false;
	}
	var gic_id=$("#update_sub_subcat1").val();
	if(gic_id.trim()=="0"){
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,category:category,msg:'update_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Category added successfully");
...
function delete_sub_subcat_validation(){
	...
	var gic_id=$("#delete_subcat1").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('delete_subcat1');
		return false;
	}
	var gic_id=$("#delete_sub_subcat1").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Sub Category");
		error_border('delete_subcat1');
		return false;
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,msg:'delete_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Category added successfully");
...
function add_sub_sub_subcat_validation(){
	var gic_id=$("#add_field2").val();
	no_border('add_field2');
	if(gic_id==0){
		alert("Please select Category");
		error_border('add_field2');
		return false;
	}
	var gic_id=$("#add_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('add_subcat2');
		return false;
	}
	var gic_id=$("#add_sub_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Sub Category");
		error_border('add_sub_subcat2');
		return false;
	}
	
	var category=$("#add_sub_sub_sub_cat").val();
	if(category.trim()==""){
		alert("Please Type Sub Sub Sub Category");
		error_border('add_sub_sub_sub_cat');
		return false;
	}
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,category:category,msg:'add_sub_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_sub_sub_subcat_validation(){
	var gic_id=$("#update_field2").val();
	no_border('update_field2');
	if(gic_id==0){
		alert("Please select Category");
		error_border('update_field2');
		return false;
	}
	var gic_id=$("#update_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('update_subcat2');
		return false;
	}
	var gic_id=$("#update_sub_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Sub Category");
		error_border('update_sub_subcat2');
		return false;
	}
	
	var gic_id=$("#update_sub_sub_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Sub Sub Category");
		error_border('update_sub_sub_subcat2');
		return false;
	}
	
	var category=$("#update_sub_sub_sub_cat").val();
	if(category.trim()==""){
		alert("Please Type Sub Sub Sub Category");
		error_border('update_sub_sub_sub_cat');
		return false;
	}
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,category:category,msg:'update_sub_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Sub Category Updated successfully");
	}
	location.reload();
	}
	);
...
function delete_sub_sub_subcat_validation(){
	var gic_id=$("#delete_field2").val();
	no_border('delete_field2');
	if(gic_id==0){
		alert("Please select Category");
		error_border('delete_field2');
		return false;
	}
	var gic_id=$("#delete_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('delete_subcat2');
		return false;
	}
	var gic_id=$("#delete_sub_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Sub Category");
		error_border('delete_sub_subcat2');
		return false;
	}
	
	var gic_id=$("#delete_sub_sub_subcat2").val();
	if(gic_id.trim()=="0"){
		alert("Please Select Sub Sub Sub Category");
		error_border('delete_sub_sub_subcat2');
		return false;
	}
	...
	$.post(
	"ajax_add_update_general_item_cat.php",
	{gic_id:gic_id,msg:'delete_sub_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Sub Category Deleted successfully");
	}
	location.reload();
	}
	);
...
<a href="javascript:void(0);">Add General Item Category</a>
</li>
</ol>
</div>
</div>
...
<div class="panel">
<div class="panel-heading">
<div class="panel-title">Add Sub Sub Sub Category
</div>
</div>
<div class="panel-body">
<form method="post" action="javascript:void(0);" id="" >
...
<div class="section">
<label class="field select">
<select name="add_field2" id="add_field2" onchange="fetch_subcat('add_subcat2','add_field2');" >
<option value="0" >Select Category </option>
<?php
$category=getDetails(doSelect("gic_id,category","general_item_category",array("parent_id"=>0)));
foreach($category as $k=>$v){
...
<div class="section">
<label class="field select">
<select name="add_subcat2" id="add_subcat2" onchange="fetch_subcat('add_sub_subcat2','add_subcat2');">
<option value="0">Select Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="section">
<label class="field select">
<select name="add_sub_subcat2" id="add_sub_subcat2">
<option value="0">Select Sub Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="section">
<label class="field prepend-icon">
<input type="text"  id="add_sub_sub_sub_cat" class="gui-input" placeholder="Enter Sub-Sub-Sub-category Name">
<label for="tooltip1" class="field-icon">
<i class="fa fa-sign-out"></i>
</label>
</label>
...
<div class="row" style="margin-top:20px;">
<div class="col-md-4">
<input class="btn btn-default btn-primary" onclick="add_sub_sub_subcat_validation();" type="submit" name="submit" value="Add" >
</div>
</div>
</form>
</div>
...
<div class="panel">
<div class="panel-heading">
<div class="panel-title">Update Sub Sub Sub Category
</div>
</div>
<div class="panel-body">
<form method="post" action="javascript:void(0);" id="" >
...
<div class="section">
<label class="field select">
<select name="update_field2" id="update_field2" onchange="fetch_subcat('update_subcat2','update_field2');" >
<option value="0" >Select Category </option>
<?php
$category=getDetails(doSelect("gic_id,category","general_item_category",array("parent_id"=>0)));
foreach($category as $k=>$v){
...
<div class="section">
<label class="field select">
<select name="update_subcat2" id="update_subcat2" onchange="fetch_subcat('update_sub_subcat2','update_subcat2');">
<option value="0">Select Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="section">
<label class="field select">
<select name="update_sub_subcat2" id="update_sub_subcat2" onchange="fetch_subcat('update_sub_sub_subcat2','update_sub_subcat2');">
<option value="0">Select Sub Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="section">
<label class="field select">
<select name="update_sub_sub_subcat2" id="update_sub_sub_subcat2">
...
<div class="section">
<label class="field prepend-icon">
<input type="text"  id="update_sub_sub_sub_cat" class="gui-input" placeholder="Enter Sub-Sub-category Name">
<label for="tooltip1" class="field-icon">
<i class="fa fa-sign-out"></i>
</label>
</label>
...
<div class="row" style="margin-top:20px;">
<div class="col-md-4">
<input class="btn btn-default btn-primary" onclick="update_sub_sub_subcat_validation();" type="submit" name="submit" value="Update" >
</div>
</div>
</form>
</div>
...
<div class="panel">
<div class="panel-heading">
<div class="panel-title">Delete Sub Sub Sub Category
</div>
</div>
<div class="panel-body">
<form method="post" action="javascript:void(0);" id="" >
...
<div class="section">
<label class="field select">
<select name="delete_field2" id="delete_field2" onchange="fetch_subcat('delete_subcat2','delete_field2');">
<option value="0" >Select Category </option>
<?php
$category=getDetails(doSelect("gic_id,category","general_item_category",array("parent_id"=>0)));
foreach($category as $k=>$v){
...
<div class="section">
<label class="field select">
<select name="delete_subcat2" id="delete_subcat2" onchange="fetch_subcat('delete_sub_subcat2','delete_subcat2');">
<option value="0">Select Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="section">
<label class="field select">
<select name="delete_sub_subcat2" id="delete_sub_subcat2" onchange="fetch_subcat('delete_sub_sub_subcat2','delete_sub_subcat2');">
<option value="0">Select Sub Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="section">
<label class="field select">
<select name="delete_sub_sub_subcat2" id="delete_sub_sub_subcat2">
<option value="0">Select Sub Sub Sub Category</option>
</select>
<i class="arrow"></i>
</label>
...
<div class="row" style="margin-top:20px;">
<div class="col-md-4">
<input class="btn btn-default btn-primary" onclick="delete_sub_sub_subcat_validation();" type="submit" name="submit" value="Delete" >
</div>
</div>
</form>
</div>
