...
function update_category_validation(){
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:category,category:new_category,msg:'update_category'},
	function(res){
		var r=res.split("||");
			if(r[1]==1){
...
{
	var cc_id=$("#delete_category_field").val();
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:cc_id,msg:'delete_category'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function add_subcat_validation(){
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:cc_id,category:category,msg:'add_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_subcat_validation(){
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:cc_id,category:category,msg:'update_subcat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function add_sub_subcat_validation(){
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:cc_id,category:category,msg:'add_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
...
function update_sub_subcat_validation(){
	...
	var cc_id=$("#update_subcat1").val();
	if(cc_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('update_subcat1');
		return false;
	}
	var cc_id=$("#update_sub_subcat1").val();
	if(cc_id.trim()=="0"){
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:cc_id,category:category,msg:'update_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Category added successfully");
...
function delete_sub_subcat_validation(){
	...
	var cc_id=$("#delete_subcat1").val();
	if(cc_id.trim()=="0"){
		alert("Please Select Sub Category");
		error_border('delete_subcat1');
		return false;
	}
	var cc_id=$("#delete_sub_subcat1").val();
	if(cc_id.trim()=="0"){
		alert("Please Select Sub Sub Category");
		error_border('delete_subcat1');
		return false;
	...
	$.post(
	"ajax_add_update_car_cat.php",
	{cc_id:cc_id,msg:'delete_sub_sub_cat'},
	function(res){
	var r=res.split("||");
			if(r[1]==1){
	alert("Sub Sub Category added successfully");
...
<a href="javascript:void(0);">Car Category</a>
</li>
</ol>
</div>
</div>
