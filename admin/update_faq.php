...
<textarea name="question" id="question" placeholder="Write Question.........." rows="2" cols="100"></textarea>
</label>
</div>

<div class="section">
<label for="answer" class="field prepend-icon">
<textarea name="answer" id="answer" placeholder="Write Answer.........." rows="5" cols="100"></textarea>
</label>
</div>
