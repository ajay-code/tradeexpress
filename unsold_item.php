...
function ajax_pagintn(page,limit=10){
	...
	$.post(
	'ajax_general_pagination.php?page='+page+'&limit='+limit+'&uploader='+uploader+'&sold_status=0&unsold=true',
	{},
	function(r){
...
function ajax_pagintn111(page,limit=1){
	var uploader='<?php if(isset($_GET["cus_id"])) {echo $_GET["cus_id"]; }else{ echo $_SESSION["ar_id"];  } ?>';
	$.post(
	'ajax_car_pagination.php?page='+page+'&limit='+limit+'&uploader='+uploader+'&sold_status=0&unsold=true',
	{},
	function(r){
...
<h1 class="page-title entry-title">Unsold Item</h1>
<?php
