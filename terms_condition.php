...
<span class="sep">&raquo;</span> <span class="trail-end">Terms & Condition</span></div></div>
<section id="content" class="multiple large-9 small-12 columns">
  ...
  <div class="hfeed">
			<div id="post-167" class="hentry page publish post-1 odd author-templatic  post ">
			               <h1 class="loop-title">Terms & Condition</h1>
            <div class="loop-description">
               <p style="text-align:justify;"><?php echo seeMoreDetails("terms","ambit_terms_services",array()); ?></p>
               </div>
               <!-- .entry-content -->
               		</div>
		<!-- .hentry -->
