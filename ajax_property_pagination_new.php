...
.nograybg{background:none!important;}
.graybg{background:#ccc!important;}
/*.grid .clientlogogrid{background:none}
.list .clientlogogrid{background:none}
.grid .graybg{background:#ccc!important;}
.list .graybg{background:none!important;}*/
</style>
...
<section id="loop_classified_taxonomy" class="search_result_listing list" >
  ...
  <article class="post  classified-1080 featured_c" style="<?php echo $background; ?>">
	...
	<?php if($v["logo"] != "" && file_exists("logo/".$v["logo"])){?>
			<div class="sort-price show-desktop clientlogogrid nograybg"> <img src="https://www.tradeexpress.co.nz/logo/<?php  echo $v["logo"]?>" width=""  class="" /></div>
	<?php }else{?>
		<div class="sort-price show-desktop clientlogogrid graybg"> Private Sale</div>
	<?php } ?>	
	  
    <!-- classified image end -->
    <div class="entry">
     
			<?php if($v["logo"] != "" && file_exists("logo/".$v["logo"])){?> <div class="sort-price show-desktop clientlogolist nograybg"> 
					<img src="https://www.tradeexpress.co.nz/logo/<?php  echo $v["logo"]?>" width=""  class="" /></div>
			<?php }else{?>
			 	 <div class="sort-price show-desktop clientlogolist nograybg">Private Sale</div>
			<?php } ?>
...
?>
	    ...
	    <?php
 			if($prop_price_type  == '1'){
			  // $prop_label= 'Asking price';
			 ?>
			 <span class="gridbottomprice"><?php  if( $prop_price_vals != "" ){echo  currency().$prop_price_vals;} ?></span> 
			 <?php  
			}else if($prop_price_type  == '2'){ // $prop_label= 'Enquiries over';?>
           			<span class="gridbottomprice"><?php echo "Enquiries over". " ".currency().$prop_price_vals ?></span> 
			<?php }else if($prop_price_type  == '3'){ // $prop_label= 'To be auctioned';?>
				<span class="gridbottomprice"><?php echo "To be auctioned";?></span> 
			<?php }else if($prop_price_type  == '4'){ // $prop_label= 'Tenders closing';?>
				<span class="gridbottomprice"><?php echo "Sale By Tender";?></span> 
			<?php }else if($prop_price_type  == '5'){ // $prop_label= 'Price by negotiation';?>
				 <span class="gridbottomprice"><?php echo "Price by negotiation" ; ?></span>  
			<?php }else if($prop_price_type  == '6'){ // $prop_label= 'Deadline Private Treaty'; ?>
				<span class="gridbottomprice"><?php echo "Deadline Private Treaty"; ?></span> 
			<?php } 
		  ?>
	...
	?>
		...
		$prop_label*/
 		  ...
 		  <?php
			...
			<?php }else if($prop_price_type  == '5'){ // $prop_label= 'Price by negotiation';?>
				 <span class="bottomprice"><?php echo "Price by negotiation" ; ?></span>  
			<?php }else if($prop_price_type  == '6'){ // $prop_label= 'Deadline Private Treaty'; ?>
