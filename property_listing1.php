...
<div id="sub_listing_categories">
	...
	<li class="cat-item cat-item-18">Sub-Category
			<ul class='children'>
				<?php
			$category=getDetails(doSelect("pc_id,category","property_category",array("parent_id"=>$_GET["category"])));
			foreach($category as $k=>$v){
				$select="";
				if(isset($_GET["sub_category"]) && $_GET["sub_category"]!="" && $_GET["sub_category"]==$v["pc_id"]){
				$select='style="color:#899516;"';	
				}
			?>
	...
	<div class="sort_options">
     ...
     <section id="loop_classified_taxonomy" class="search_result_listing list" >
		...
		$condition=array_merge($condition,$con1,$con2,$con3);
		$prop_dtls_limit=getDetails(doSelect($select,$from,$condition,$limit));
		$total_prop_dtls=getDetails(doSelect($select,$from,$condition));
          ...
          <!-- classified image end -->
                            <div class="entry">
                              ...
                              <li class="favourite">				<span id="tmplfavorite_1080" class="fav fav_1080"><a title="Add to favorites" href="javascript:void(0);" data-reveal-id="tmpl_reg_login_container" id="tmpl_login_frm_1080" data-id='1080'  class="addtofav  small_btn"  onclick="javascript:addToFavourite('1080','add');">Add to favorites</a></span>
                                                            ...
                                                            <li class="review"> <a href="details.php">8 &nbsp;</a></li>
                              </ul></div>                         		</div>
        ...
        <div id="listpagi">
				...
				<a href="javascript:void(0);" class="next page-numbers"><strong>PREV</strong></a>
				<?php
                }
                ?>
				...
				for($p=$s;$p<$page;$p++){
				  if($p!=$page){
				?>
				<a href="javascript:void(0);" class="page-numbers"><strong><?php echo $p; ?></strong></a>
				<?php
				}else{
				?>
				...
				if($l==5){
				  break;
									...
									if($page < $total_page){
									  $next=$page+1;
									  ?>
									  <a href="javascript:void(0);" class="next page-numbers"><strong>NEXT</strong></a>
									  <a href="javascript:void(0);" class="next page-numbers"><strong>LAST</strong></a>
									  <?php
									  }
									  ?>
			    </div>
...
<!--taxonomy  sidebar -->
	<aside id="sidebar-primary" class="sidebar large-3 small-12 columns">
		...
		<ul class="horizontal_location_nav">
			...
			<input name="min_price" id="min_price" value="" type="text" class="textfield ">	
			<label class=r_lbl>Maximum Price</label>	
			<input name="max_price" id="max_price" value="" type="text" class="textfield ">	
			</div>
			 ...
			 <li>
				  <select name="region" id="region" filterdisplayname="State">
		...
		<h4>Bedroom</h4>
			...
			<input name="post_title" id="post_title" value="" type="text" class="textfield ">
			</ul>
		<h4>Bathroom</h4>
