...
<span class="sep">&raquo;</span> <span class="trail-end">About Us</span></div></div>
<section id="content" class="multiple large-9 small-12 columns">
  ...
  <div class="hfeed">
			<div id="post-167" class="hentry page publish post-1 odd author-templatic  post ">
			               <h1 class="loop-title">About Us</h1>
            <div class="loop-description">
               <p style="text-align:justify;"><?php echo seeMoreDetails("about","ambit_about",array()); ?></p>
               </div>
               <!-- .entry-content -->
               		</div>
		<!-- .hentry -->
