...
$mail->addAddress($email, $seller);

$mail->isHTML(true);

$mail->Subject = "Declined Offer: Trade Express";
ob_start();                      // start capturing output
include('decline_offer_mail_html.php');   // execute the file
$mailcontent = ob_get_contents();    // get the contents from the buffer
$mail->Body = $mailcontent;
$mail->AltBody = "Fixed Price Offer By Team Trade Express";
ob_end_clean();        
