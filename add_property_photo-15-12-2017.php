...
<?php
	...
	$data = [
		...
		'sub_cat_id' => isset($_POST["sub_cat_id"]) ? $_POST["sub_cat_id"]: '',
		'sub_sub_cat_id' => isset($_POST["sub_sub_cat_id"]) ? $_POST["sub_sub_cat_id"]: '',
		'listing_title' => isset($_POST["listing_title"]) ? $_POST["listing_title"]: '',
		'listing_duration' => isset($_POST["listing_duration"]) ? $_POST["listing_duration"]: '',
		'street' => isset($_POST["street"]) ? $_POST["street"]: '',
		'unit_flat' => isset($_POST["unit_flat"]) ? $_POST["unit_flat"]: '',
		'street_name' => isset($_POST["street_name"]) ? $_POST["street_name"]: '',
		'region' => isset($_POST["region"]) ? $_POST["region"]: '',
		'country' => isset($_POST["country"]) ? $_POST["country"]: '',
		'city' => isset($_POST["city"]) ? $_POST["city"]: '',
		'suburb' => isset($_POST["suburb"]) ? $_POST["suburb"]: '',
		'rateable_value' => isset($_POST["rateable_value"]) ? $_POST["rateable_value"]: '',
		'rateable_value_hide' => isset($_POST["rateable_value_hide"]) ? $_POST["rateable_value_hide"]: '',
		'expected_sale_price' => isset($_POST["expected_sale_price"]) ? $_POST["expected_sale_price"]: '',
		'bedroom' => isset($_POST["bedroom"]) ? $_POST["bedroom"]: '',
		'bathroom' => isset($_POST["bathroom"]) ? $_POST["bathroom"]: '',
		'floor_area' => isset($_POST["floor_area"]) ? $_POST["floor_area"]: '',
		'open_home_date' => isset($_POST["open_home_date"]) ? $_POST["open_home_date"]: '',
		'open_home_strt_time' => isset($_POST["open_home_strt_time"]) ? $_POST["open_home_strt_time"]: '',
		'open_home_end_time' => isset($_POST["open_home_end_time"]) ? $_POST["open_home_end_time"]: '',
		'prop_desc' => isset($_POST["prop_desc"]) ? $_POST["prop_desc"]: '',
		'parking' => isset($_POST["parking"]) ? $_POST["parking"]: '',
		'amenities' => isset($_POST["amenities"]) ? $_POST["amenities"]: '',
		'smoke_alarm' => isset($_POST["smoke_alarm"]) ? $_POST["smoke_alarm"]: '',
		'agency_reference' => isset($_POST["agency_reference"]) ? $_POST["agency_reference"]: '',
		...
		'email_address2' => isset($_POST["email_address2"]) ? $_POST["email_address2"]: '',
		'agency' => isset($_POST["agency"]) ? $_POST["agency"]: '',
		'landline' => isset($_POST["landline"]) ? $_POST["landline"]: '',
		'landline2' => isset($_POST["landline2"]) ? $_POST["landline2"]: '',
		'mobile2' => isset($_POST["mobile2"]) ? $_POST["mobile2"]: '',
		'website_address' => isset($_POST["website_address"]) ? $_POST["website_address"]: '',
		'logo' => isset($_POST["logo"]) ? $_POST["logo"]: '',
		'view_counter' => isset($_POST["view_counter"]) ? $_POST["view_counter"]: '',
		'specify_price' => isset($_POST["specify_price"]) ? $_POST["specify_price"]: '',
		'duration_type' => isset($_POST["duration_type"]) ? $_POST["duration_type"]: '',
		'outgoing_gross_lease' => isset($_POST["outgoing_gross_lease"]) ? $_POST["outgoing_gross_lease"]: '',
		'rent' => isset($_POST["rent"]) ? $_POST["rent"]: '',
		'max_number_of_tenants' => isset($_POST["max_number_of_tenants"]) ? $_POST["max_number_of_tenants"]: '',
		...
		'ideal_tenants' => isset($_POST["ideal_tenants"]) ? $_POST["ideal_tenants"]: '',
		'furniture_and_whiteware_provided' => isset($_POST["furniture_and_whiteware_provided"]) ? $_POST["furniture_and_whiteware_provided"]: '',
		/* 
		* to add additional fielsd check 'add_property' table columns in database 
		* you can only add data for existing columns otherwise it will produce error
		*/
	];
	dd($data);

	$status=doInsert($data,"add_property");	
