                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hi <?=$buyer_name?>, </b><br>
                            <p>Congratulatons, You Met the set Reserve price.</p>
                          </td>
                        </tr>
                        <tr>
                          <td>
                        ...
                        <tr>
                          <td>
                            <p>Please contact the seller to arrange shipping and payment.</p>
                            <h2>Seller Details</h2>
                            <h3 style="text-align:center"><?=$seller_name?></h3>
                            <h3 style="text-align:center"><?=$seller_email?></h3>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <p>Please place your feedback on your dealing with seller.</p>
                          </td>
                        </tr>
                        <tr>
