...
$mail->Subject = "Reserve Price Met: Trade Express";
ob_start();                      // start capturing output
include('seller_reserve_price_mail_html.php');   // execute the file
$mailcontent = ob_get_contents();    // get the contents from the buffer
$mail->Body = $mailcontent;
$mail->AltBody = "Reserve Price Met By Team Trade Express";
ob_end_clean();        
