...
?>
 <section id="content" class="large-9 small-12 columns">
                ...
                <div id="post-46" class="hentry page publish post-1 odd author-templatic  post ">
                    <h1 class='page-title entry-title'>Updit Classified (Property)</h1>
...
?>			
			<div class="form_row clearfix custom_fileds  owner_name">
					<label class=r_lbl>Listing Duration :<span class="required">*</span></label>					<select name="listing_duration" id="datepicker21" class="textfield textfield_x " style="border:1px solid #ddd;">                      <option value="0">--Select Listing--</option>                      <option value="21" <?php echo ($listing_duration == '21')?'selected="selected"':'';?> >21 Days</option>                      <option value="28" <?php echo ($listing_duration == '28')?'selected="selected"':'';?> >28 Days</option>                      <option value="35" <?php echo ($listing_duration == '35')?'selected="selected"':'';?> >35 Days</option>                      <option value="42" <?php echo ($listing_duration == '42')?'selected="selected"':'';?> >42 Days</option>                      <option value="60" <?php echo ($listing_duration == '60')?'selected="selected"':'';?> >60 Days</option>                    </select>
...
<div id="step-plan" class="accordion-navigation step-wrapper step-plan current">
			...
			<div class="form_row clearfix custom_fileds  owner_name">
					<label class=r_lbl>Bedroom :<span class="required">*</span></label>					<select name="bedroom" id="datepicker21" class="textfield textfield_x " style="border:1px solid #ddd;">                      <option value="0">--Select Bedroom--</option>                      <option value="1" <?php echo ($v2["bedroom"] == '1')?'selected="selected"':'';?> >1</option>                      <option value="2" <?php echo ($v2["bedroom"] == '2')?'selected="selected"':'';?> >2</option>                      <option value="3" <?php echo ($v2["bedroom"] == '3')?'selected="selected"':'';?> >3</option>                      <option value="4" <?php echo ($v2["bedroom"] == '4')?'selected="selected"':'';?> >4</option>                      <option value="5" <?php echo ($v2["bedroom"] == '5')?'selected="selected"':'';?> >5</option>					  <option value="6+" <?php echo ($v2["bedroom"] == '6+')?'selected="selected"':'';?> >6+</option>                    </select>
                    <!--input name="bedroom"  id="bedroom" value="<?php echo $v2["bedroom"]; ?>" type="text" class="textfield "  placeholder=" "/-->
				<span id="owner_name_error " class="message_error2 "></span>     
			</div>
			
			<div class="form_row clearfix custom_fileds  owner_name">
					<label class=r_lbl>Bathroom :<span class="required">*</span></label>										<select name="bathroom" id="datepicker21" class="textfield textfield_x " style="border:1px solid #ddd;">                      <option value="0">--Select Bedroom--</option>                      <option value="1" <?php echo ($v2["bathroom"] == '1')?'selected="selected"':'';?> >1</option>                      <option value="2" <?php echo ($v2["bathroom"] == '2')?'selected="selected"':'';?> >2</option>                      <option value="3" <?php echo ($v2["bathroom"] == '3')?'selected="selected"':'';?> >3</option>                      <option value="4" <?php echo ($v2["bathroom"] == '4')?'selected="selected"':'';?> >4</option>                      <option value="5" <?php echo ($v2["bathroom"] == '5')?'selected="selected"':'';?> >5</option>					  <option value="6+" <?php echo ($v2["bathroom"] == '6+')?'selected="selected"':'';?> >6+</option>                    </select>
                    <!--input name="bathroom"  id="bathroom" value="<?php echo $v2["bathroom"]; ?>" type="text" class="textfield "  placeholder=" "/-->
				<span id="owner_name_error " class="message_error2 "></span>     
			</div>
