...
<span class="sep">&raquo;</span> <span class="trail-end">Privacy Plicy</span></div></div>
<section id="content" class="multiple large-9 small-12 columns">
  ...
  <div class="hfeed">
			<div id="post-167" class="hentry page publish post-1 odd author-templatic  post ">
			               <h1 class="loop-title">Privacy Policy</h1>
            <div class="loop-description">
               <p style="text-align:justify;"><?php echo seeMoreDetails("privacy","ambit_privacy_policy",array()); ?></p>
               </div>
               <!-- .entry-content -->
               		</div>
		<!-- .hentry -->
