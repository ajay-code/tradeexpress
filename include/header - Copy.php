...
<link rel="pingback" href="images/xmlrpc.php" />
	...
	<script>
		var closeimg = '../../maps.gstatic.com/images/close.gif';
...
<script type='text/javascript' src='../../code.jquery.com/images/jquery-ui.js'></script>
...
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="images/wlwmanifest.xml" /> 
		...
		<script src="../../www.google.com/images/apif977.js?onload=onloadCallback&amp;render=explicit&amp;hl=en"></script>
	...
	<script  type="text/javascript" async >
		...
		var thousands_sep   = ',';
    						...
    						<meta property="og:image" content="classifieds/wp-content/uploads/bulk/mobile-tablets(1).jpg" />
											<meta name="twitter:image" content="classifieds/wp-content/uploads/bulk/mobile-tablets(1).jpg" />
...
<li id="menu-item-221" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-221"><a href="javascript:void(0);">Post Item</a>
<ul class="sub-menu">
...
<li id="menu-item-20071" class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="property_post.php">Property</a>
<li id="menu-item-20071" class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="job_post.php">Job</a>
<li id="menu-item-20071" class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="car_post.php">Car, Motorbikes & Boats</a>
</ul>
</li>
<li id="menu-item-20081" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20081"><a href="vendor_listing.php">Vendor</a></li>
...
<form name="searchform_1946522128" method="get" class="searchform_1946522128 allinone" id="searchform" action="search_item.php" style="position:relative;">
    <input type="text"  value="" name="search" id="search" class="searchpost" placeholder="Looking For ..." size="100"/>
    <input type="submit" class="sgo"  value="Search" />
</form>

		  
        </div></div></div><div id="templatic_text-2" class="widget templatic_text"><div class="widget-wrap widget-inside">		<div class="textwidget">	<a class="button post-free-classifieds-btn" href="javascript:void(0);" onclick="post_item();">+ Post an ad</a>	</div>
		</div></div>	</aside>
          ...
          <!-- .wrap -->
        		...
        		<div id="menu_secondary_mega_menu" class="mega_menu_wrap ">
					<div id="menu-secondary-title" class="currentmenu3 currentmenu2">
						Menu					</div>					
					<div class="nav_bg">
						<ul id="menu-secondary-1" class="mega"><li class="menu-item menu-item-type-post_type current-menu-item menu-item-object-page menu-item-home menu-item-203"><a href="index.php">Home</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-221"><a href="javascript:void(0);">Post Item</a>
<ul class="sub-menu">
<li class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="general_item_post.php">General Item</a></li>
<li class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="property_post.php">Property</a></li>
<li class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="job_post.php">Job</a></li>
<li class="menu-item menu-item-type-taxonomy menu-item-object-classifiedscategory menu-item-has-children menu-item-20071"><a href="car_post.php">Car, Motobikes & Boats</a></li>
</ul>	
</li>


<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20081"><a href="vendor_listing.php">Vendor</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1706"><a href="register.php">Register</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-215"><a href="about_us.php">About Us</a></li>
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1732"><a href="contact_us.php">Contact Us</a></li>
