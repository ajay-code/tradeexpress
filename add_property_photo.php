...
//echo '<pre>';
//print_r($_POST);
$sub_cat_id_agen=@$_POST["sub_cat_id_agen"];
...
<?php if($next_form=='photo_upload'){ 
	...
	?>
  <input type="hidden" name="sub_cat_id_agen" value="<?php echo @$_POST["sub_cat_id"]; ?>">
	<div id="ajax_fetch_form" style="display:none;">
		<div class="form_row clearfix custom_fileds  owner_name">
			...
			<div class="row" style="background:wheat;padding:20px;">
				...
				<div class="col-md-12 col-sm-12" style="text-align: center; margin-bottom: 10px;">
					<input  id="image"  name="image[]" multiple  value="" type="file" class="textfield "  placeholder=" " style="margin:0 auto;"/>
				</div>
				<br/>
		...
		<div class="form_row clearfix custom_fileds  owner_name">
			...
			<div class="row" style="background:wheat;padding:20px;">
				<div class="col-md-12 col-sm-12" style="text-align: center; margin-bottom: 10px;">
					<input name="video" id="video"  value="" type="text" class="textfield "  placeholder=" "/>
				</div>
				<br/>
...
<?php if($next_form=='special_features_and_price'){ ?>
	<div id="ajax_fetch_form" style="display:none;">	
		<?php if(@$_POST["sub_cat_id_agen"]=="22") { ?>
		<div id="step-plan" class="accordion-navigation step-wrapper step-plan current">		
			<a class="step-heading active" href="javascript:void(0);">			
				...
				<span>Rental Combo<?php echo show_price_classifiedDb('rental_combo');  ?></span>			
		...
		<div id="step-plan" class="accordion-navigation step-wrapper step-plan current">		
			<a class="step-heading active" href="javascript:void(0);">			
				...
				<span>Rental Featured <?php echo show_price_classifiedDb('rental_feature');  ?></span>			
				<span><i class="fa fa-caret-down"></i><i class="fa fa-caret-right"></i></span>		
			</a>		
			<div id="plan" class="content step-plan  active  clearfix">			
				<div id="packagesblock-wrap" class="block">				
		...
		<div id="step-plan" class="accordion-navigation step-wrapper step-plan current">		
			<a class="step-heading active" href="javascript:void(0);">			
				...
				<span>Rental Highlight <?php echo show_price_classifiedDb('rental_highlights');  ?></span>			
				<span><i class="fa fa-caret-down"></i><i class="fa fa-caret-right"></i></span>		
			</a>        
			<div id="plan" class="content step-plan  active  clearfix">            
				<div id="packagesblock-wrap" class="block">				
					<div class="packageblock clearifx ">					
						<ul data-price="0" data-subscribed='0' data-id="15" data-type="1" class="packagelistitems ">						
							<li>							
								<div class="col-md-12 col-sm-12">								
									<div class="panel panel-default text-center" style="padding-right:0;">									
									<!--	<div class="panel-heading"><h3>Fee</h3></div>									
										<div class="panel-desc">										
											<div class="panel-body"> -->											
		...
		<div id="step-plan" class="accordion-navigation step-wrapper step-plan current">		
			<a class="step-heading active" href="javascript:void(0);">			
				...
				<span>Rental Bold <?php echo show_price_classifiedDb('rental_bold');  ?></span>			
				<span><i class="fa fa-caret-down"></i><i class="fa fa-caret-right"></i></span>		
			</a>        
			<div id="plan" class="content step-plan  active  clearfix">            
				<div id="packagesblock-wrap" class="block">				
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					?>
									...
									<!-- Rent -->
									<tr>
										<td class="first-columns">Rent</td>
										<td class="second-columns"><span class="property-cols">:</span><?php echo $getPropertyDetailsData['rent'];?></td>
									</tr>	
									<tr>
										<td class="first-columns">Pets allowed</td>
										<td class="second-columns"><span class="property-cols">:</span><?php echo $getPropertyDetailsData['pets'];?></td>
									</tr>
									<tr>
										<td class="first-columns">Smokers allowed</td>
										<td class="second-columns"><span class="property-cols">:</span><?php echo $getPropertyDetailsData['smoker'];?></td>
									</tr>
									<tr>
										<td class="first-columns">Ideal Tenants</td>
						<td class="second-columns"><span class="property-cols">:</span><?php echo $getPropertyDetailsData['ideal_tenants'];?></td>
									</tr>
									<!--<tr>
									...
									<!--<tr>
										<td colspan="2" class="heading">Open Home Details</td>
									</tr>
									<tr>
...
<?php	if($db_name=="add_property"){	
	...
	//$status=doInsert($allData,"add_property");
	//var_dump($_POST);
	//var_dump($status);
	//var_dump("add_property");
...
//var_dump($status);		
		...
		if($status){			
			...
			$status=doInsert($contact_table_field,"add_property_contact_dtls");		
				//var_dump($status);
				//var_dump("add_property_contact_dtls");
			if($status){				
				echo ' || 1';			
			}else{				
				echo ' || 0';
...
<?php if($db_name=="add_property_extra_field"  && isset($_SESSION["recent_id"])){
	...
	$res=doUpdate("add_property",array("posting_status"=>0),array("ap_id"=>$_SESSION["recent_id"]));
	//var_dump($res);
	echo ' || 1';}
...
<?php if($db_name=="add_property_listing_features"  && isset($_SESSION["recent_id"])){
	...
	$res=doUpdate("add_property",$update_position,array("ap_id"=>$_POST["ap_id"]));			
	//var_dump(@$res);
	//unset($_SESSION["recent_id"]);	
