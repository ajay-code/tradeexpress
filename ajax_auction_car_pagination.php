...
<?php
	...
	$select="acb_id,acm_id,cus_id,bid_price,date";
	$con=array("acm_id"=>$_GET["acm_id"]);
	$action_details=getDetails(doSelect1($select,"ambit_car_bid",$con,$oredr_by.$limit));
	$action_details_total=getDetails(doSelect1($select,"ambit_car_bid",$con,$oredr_by));
