...
$mail->Subject = "Offer sold to some other member: Trade Express";
ob_start();                      // start capturing output
include('offer_sold_mail_html.php');   // execute the file
$mailcontent = ob_get_contents();    // get the contents from the buffer
$mail->Body = $mailcontent;
$mail->AltBody = "Offer sold to some other member By Team Trade Express";
ob_end_clean();        
